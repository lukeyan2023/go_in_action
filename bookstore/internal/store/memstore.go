...
// Get retrieves a book from store, by id. if no such id exists . an error is returned
...
// Delete the book with the given id. if no such id exists, an error is returned
